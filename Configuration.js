...
function getEndpoints(deviceAddress, endpoints)
{
   ...
   endpoints.addEndpoint("2", "SOS", endpointType.iasSensor, iasEndpointSubType.alarmInput);
   endpoints.addEndpoint("3", "Temperature", endpointType.temperatureSensor);
   endpoints.addEndpoint("4", "Battery", endpointType.genericSensor);
   endpoints.addEndpoint("5", "GPS Fix", endpointType.genericSensor);
}
