...
# Parsing + Configuration Script – MicroTracker V2 - Rev. A

This **Parsing + Configuration** script is designed for the **MicroTracker V2** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – MicroTracker V2 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **MicroTracker V2** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
